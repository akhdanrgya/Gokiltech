        ...
        <section className="relative flex flex-col items-center justify-center w-full min-h-screen px-6 text-center sm:text-left">
            ...
            <div className="relative z-10 flex flex-col items-center sm:items-start max-w-4xl mx-auto space-y-6">
                ...
                <p className="text-base sm:text-lg md:text-xl max-w-2xl">
                    A <span className="text-purple">community</span> of developers and tech enthusiasts exploring, innovating, and growing together in the world of technology.
                </p>

                <Button variant="bordered" className="border-purple px-6 py-3 text-base sm:text-lg">
                    Let’s Get In Touch!
                </Button>
            </div>
        </section>
